...
import {
  StudentDashboard, MyCoursesPage, QuizPage, CertificatesPage, NotificationsPage,
} from './pages/StudentPages';
import {
  TrainerDashboard, TrainerContentPage, AttendancePage, CreateQuizPage,
} from './pages/TrainerPages';
import {
  AdminDashboard, UserManagementPage, CourseManagementPage, AnalyticsPage,
  ...
  const pageMap = {
    ...
    courseDetail: (
      <CourseDetailPage
        ...
        role={role}
        onBack={() => goPublic('courses')}
        onShowLogin={showLogin}
        onShowLockedModal={() => setShowModal(true)}
      />
    ),
    ...
    <div className="app">
      ...
      <div className="main">
        ...
        <div className="content">
          {renderPage(state.page, state, actions)}
        </div>
      </div>

      {/* Login Modal — renders its own backdrop internally */}
        ...
        <div className="modal-backdrop">
          <div className="modal">
            ...
            <div className="modal-sub">
              ...
              {state.courseView?.lessons || 42} lessons and track your progress.
            </div>
