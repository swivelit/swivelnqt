...
import { AdminDashboard, UserManagementPage, TrainerManagementPage, CourseManagementPage, AnalyticsPage , SettingsPage ,NotificationModule} from './pages/AdminPages';
